...
public class StateMachineConfig extends StateMachineConfigurerAdapter<PaymentState, PaymentEvent> {
    ...
    @Autowired
    public StateMachineConfig(@Qualifier("preAuthAction") Action<PaymentState, PaymentEvent> preAuthAction,
                              @Qualifier("authAction") Action<PaymentState, PaymentEvent> authAction,
                              @Qualifier("paymentIdGuard") Guard<PaymentState, PaymentEvent> paymentIdGuard,
                              @Qualifier("preAuthApprovedAction") Action<PaymentState, PaymentEvent> preAuthApprovedAction,
                              @Qualifier("preAuthDeclinedAction") Action<PaymentState, PaymentEvent> preAuthDeclinedAction,
                              @Qualifier("authApprovedAction") Action<PaymentState, PaymentEvent> authApprovedAction,
                              @Qualifier("authDeclinedAction") Action<PaymentState, PaymentEvent> authDeclinedAction) {
        this.preAuthAction = preAuthAction;
        this.authAction = authAction;
        this.paymentIdGuard = paymentIdGuard;
        this.preAuthApprovedAction = preAuthApprovedAction;
        this.preAuthDeclinedAction = preAuthDeclinedAction;
        this.authApprovedAction = authApprovedAction;
        this.authDeclinedAction = authDeclinedAction;
    }
